...
import { AcademicCalendarForm } from "./type";
...
export default function Page(): ReactNode {
    ...
    const { data, setData, post, processing, errors, reset } = useForm<AcademicCalendarForm>({
        year_academic: '',
        image: null,
    })
    ...
    const submitForm: FormEventHandler = (e) => {
        ...
        post(route('administrator.academic-calendars.store'));
    }
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-md sm:rounded-lg py-8 px-8">
                        <div className="border-b-2 mb-4 py-4 border-slate-200">
                            <Button variant="secondary" asChild>
                                <Link href={route('administrator.academic-calendars')}>Kembali</Link>
                            </Button>
                        </div>
