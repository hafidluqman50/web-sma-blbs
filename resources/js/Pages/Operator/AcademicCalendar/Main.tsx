...
export default function Page({academic_calendars, page_num}: PageProps<AcademicCalendarProps>): ReactNode {
    ...
    const deletePrompt = (id: number) => {
        Swal.fire({
            ...
            if(result.isConfirmed) {
                router.delete(route('operator.academic-calendars.delete', id))
            }
        })
    }
    ...
    return(
        <>
            ...
            <div className="flex">
                    <Link href={route('operator.academic-calendars.create')}>
                    ...
                    <Button className="m-2" onClick={() => {
                        router.get(route('operator.academic-calendars', {
                            search
                        }))
                    }}>Cari</Button>
            </div>
                                ...
                                <TableCell>
                                    <div className="flex space-x-4">
                                        <Button className="bg-amber-500 text-white hover:bg-amber-500" asChild>
                                            <Link href={route('operator.academic-calendars.edit', row.id)}><Pencil /></Link>
                                        </Button>
